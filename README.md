...
| [Enum('hello' = 1, 'world' = 2)<br>Enum8('hello' = 1, 'world' = 2)<br>Enum16('hello' = 1, 'world' = 2)](https://clickhouse.com/docs/en/sql-reference/data-types/enum)                | `{:enum8, hello: 1, world: 2}`<br>`{:enum16, hello: 1, world: 2}`<br>`{:enum8, [{"hello", 1}, {"world", 2}]}`<br>`{:enum16, [{"hello", 1}, {"world", 2}]}` | `:hello`<br>`"hello"`                             |
