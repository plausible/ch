defmodule Ch.RowBinaryUUIDTest do
  ...
  property "RowBinary UUID inserts round-trip through ClickHouse", %{pool: pool} do
    ...
    on_exit(fn -> Ch.Test.query("DROP TABLE row_binary_uuid_property") end)
    ...
    check all rows <- rowbinary_uuid_rows() do
      ...
      Ch.query!(pool, "INSERT INTO row_binary_uuid_property FORMAT RowBinary", rowbinary,
        encode: false
      )
  ...
  test "RowBinary inserts cover nullable, arrays, tuples, and defaults", %{pool: pool} do
    ...
    on_exit(fn -> Ch.Test.query("DROP TABLE row_binary_uuid_representative") end)
    ...
    Ch.query!(pool, "INSERT INTO row_binary_uuid_representative FORMAT RowBinary", rowbinary,
      encode: false
    )
