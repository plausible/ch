defmodule Ch.RowBinaryBoolTest do
  ...
  test "RowBinary Bool inserts round-trip through ClickHouse", %{pool: pool} do
    ...
    on_exit(fn -> Ch.Test.query("DROP TABLE row_binary_bool_values") end)
    ...
    Ch.query!(pool, "INSERT INTO row_binary_bool_values FORMAT RowBinary", rowbinary,
      encode: false
    )
  ...
  test "RowBinary inserts cover nullable, arrays, tuples, maps, and defaults", %{pool: pool} do
    ...
    on_exit(fn -> Ch.Test.query("DROP TABLE row_binary_bool_representative") end)
    ...
    Ch.query!(pool, "INSERT INTO row_binary_bool_representative FORMAT RowBinary", rowbinary,
      encode: false
    )
