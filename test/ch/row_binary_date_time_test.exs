defmodule Ch.RowBinaryDateTimeTest do
  ...
  property "RowBinary Date and DateTime inserts round-trip through ClickHouse", %{pool: pool} do
    ...
    on_exit(fn -> Ch.Test.query("DROP TABLE row_binary_date_time_property") end)
    ...
    check all rows <- rowbinary_date_time_rows() do
      ...
      Ch.query!(pool, "INSERT INTO row_binary_date_time_property FORMAT RowBinary", rowbinary,
        encode: false
      )
  ...
  property "RowBinary Time inserts round-trip through ClickHouse", %{pool: pool} do
    ...
    on_exit(fn -> Ch.Test.query("DROP TABLE row_binary_time_property") end)
    ...
    check all rows <- rowbinary_time_rows() do
      ...
      Ch.query!(pool, "INSERT INTO row_binary_time_property FORMAT RowBinary", rowbinary,
        encode: false
      )
  ...
  test "RowBinary inserts cover nullable, arrays, tuples, and defaults", %{pool: pool} do
    ...
    on_exit(fn -> Ch.Test.query("DROP TABLE row_binary_date_time_representative") end)
